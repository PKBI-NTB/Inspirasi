...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-white md:dark:bg-white dark:border-white">
                    ...
                    <li>
                        <a href="#" class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Berita</a>
                    </li>
                    <li>
    ...
    <div class="flex flex-col md:flex-row items-center justify-between mt-11 pt-0 pb-0">
        <!-- Bagian Teks -->
        ...
        <div class="flex flex-col md:flex-row justify-between items-start">
            ...
            <div class="md:w-1/6 mb-0 md:mb-0">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-600 hover:text-gray-900">Profil</a></li>
                    <li><a href="#" class="text-gray-600 hover:text-gray-900">Program</a></li>
                    <li><a href="#" class="text-gray-600 hover:text-gray-900">Berita</a></li>
